...
Vehicle::Vehicle(const char* modelI, const char* regNumberI, int productionYear, const char* vignetteExpiryDateI, char requiredCategory): productionYear(productionYear), requiredCategory(requiredCategory){
